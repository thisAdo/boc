...
function normalizePlugin(definition = {}, file = '') {
  ...
  return {
    ...
    ownerOnly: definition.ownerOnly === true || definition.isOwner === true || definition.owner === true || definition.owners === true,
    groupOnly: definition.groupOnly === true || definition.isGroup === true || definition.group === true,
    userAdminOnly: definition.userAdminOnly === true || definition.useradmin === true || definition.isAdmin === true || definition.admin === true || definition.adminOnly === true,
    botAdminOnly: definition.botAdminOnly === true || definition.botadmin === true || definition.isBotAdmin === true || definition.botAdmin === true,
